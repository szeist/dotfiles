...
/* package conduit-extra-1.1.13.1 */
#define VERSION_conduit_extra "1.1.13.1"
#define MIN_VERSION_conduit_extra(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 13)

/* package imagesize-conduit-1.1 */
#define VERSION_imagesize_conduit "1.1"
#define MIN_VERSION_imagesize_conduit(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
...
#define CURRENT_PACKAGE_KEY "szeis_0Ay9AQNHj49E0X62SRWB21"
